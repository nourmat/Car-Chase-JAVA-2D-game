...
public class GrassPanel extends MasterPanel {
    ...
    private static final int terrineType= GameConst.GRASSMODE;
    ...
    private static final int sideBackgroundImages = 22;
    private static final ImageIcon[] loadedVehicleImageIcons = new ImageIcon[numberOfVehicle];

    public GrassPanel(Player player, int modeType) {
