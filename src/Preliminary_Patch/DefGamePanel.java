...
public class DefGamePanel extends JPanel {


    /**
     * thin class is used to draw the defence mode Game panel
     * it controllers the player and the vehicles
     */
    ...
    private int score = 0;
    private int lives = 3;
    private int rockets = 10; // number of rockets left
    private int level = 1;

    private JFrame frame; // this is a refrence to the Frame containing the Gamepanel
...
//    private String backgroundImagesDirectory; // in mode panel
    ...
    public DefGamePanel (Player player ,int terrineType ,ImageIcon[] loadedVehicleImageIcons,
...
//        this.playingBackgroundSpeed = playingBackgroundSpeed;
    ...
    /**this is function is called in the constructor
     * containes 3 timers
     *  timer this is used to create the objects and adds them in the arraylist
     *  timer2 this is used to move and check collision of the objects
     *  increaseMinSpeed is used to increase the speed and level up
     * the action listener is initialized in this function
     */
                            ...
                            public void run() {
                                if (terrineType == GameConst.GRASSMODE || terrineType == GameConst.DESERTMODE) {
                                    if (GameConst.motorSound != null)
                                        ...
                                        if (GameConst.shipBell != null) {
                                            GameConst.shipBell.play();
                                        }
                                    }
                            }
                        });
    ...
    public void paint(Graphics graphics) {
        ...
        if (terrineType == GameConst.DESERTMODE)
            ...
            graphics.drawImage(new ImageIcon(".\\src\\BoatMode\\water background.png").getImage(),
                    0,0,GameConst.getSCREENWIDTH(),GameConst.getGamePanelHEIGHT(),null);
        else if (terrineType == GameConst.GRASSMODE){
            graphics.drawImage(new ImageIcon(".\\src\\CarMode\\Background\\road2.png").getImage(),
                    0,0,GameConst.getSCREENWIDTH(),GameConst.getGamePanelHEIGHT(),null);
        }
...
//            backgroundImageNumber = 0;
    ...
    /**this function is used to check Collision of the player and a pased vehicle
     * @param vehicle the vehicle that will be tested to see if it collides with the player
     */
    ...
    public boolean checkCollision(Vehicle vehicle) {
        ...
        if (((vehicleX < playerX && playerX < vehicleX + vehicle.getWidth())
            ...
            if ((vehicle instanceof Cars || vehicle instanceof Boats) && !vehicle.isBeingDestroyed()) {
                lives--;
...
//                    JOptionPane.showMessageDialog(null, "you lost");
    ...
    /** this function takes two objects and checks if they collide
     * @param vehicle first vehicle
     *@param rocket second vehicel
     */
    ...
    /**this function is used to move the player down*/
    ...
    /**this function is used to move the player up*/
    ...
    /**this function is used to move the player Left using a timer to increase the speed and another to decrease the speed
     * @param timer first timer
    ...
    /**
     * this function return a vehicle object depending on the terrineType (grass , desert ,sea)
     * @return vehicle (Cars or Boat)
     */
    ...
    public Vehicle getAVehicle() {
        ...
        if (terrineType == GameConst.BOATMODE) {
            ...
            System.out.println("Mode Type = "+terrineType);
        }
        ...
        System.out.println(GameConst.getGamePanelHEIGHT() - vehicle.getHeight());
        /**
    ...
    /**
     * This function creats a Heart object the extends vehicle and return a vehicle object
     * @return vehicle object (Heart)
     */
    ...
    /**
     * This function creats a Coin object the extends vehicle and return a vehicle object
     * @return vehicle object (coin)
     */
    ...
    /**
     * it creates a rocket or a cannon ball depending on the terrine
     * and adds it to the arraylist to be drawn
     */
    ...
    /**
     * takes the palyer minspeed and updates the creating and moving variable to control the
     * speed of the drawn objects
     */

    public void updateMovingSpeed() {
        movingDelay = player.getMinVelocity() - 3; //Ex. 100 Max is 10 delay analogy
    ...
    /**
     * this terminates the Jfram and closes all sounds and timers
     */
